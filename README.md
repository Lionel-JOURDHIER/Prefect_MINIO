...
Ce projet  est en version 0.1.1 et appartient à Lionel-JOURDHIER.

[![Documentation](https://img.shields.io/badge/Documentation-GitHub%20Pages-blue?logo=github&logoColor=white)](https://lionel-jourdhier.github.io/Prefect_MINIO/) [![Code](https://img.shields.io/badge/Code-0.1.1-181717?logo=github)](https://github.com/Lionel-JOURDHIER/Prefect_MINIO) ![Deploy Documentation](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/actions/workflows/documentation.yml/badge.svg) [![Python Tests](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/actions/workflows/test.yml/badge.svg)](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/actions)  [![Ruff Status](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/actions/workflows/ruff.yml/badge.svg)](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/actions) ![Security Audit](https://img.shields.io/badge/Security-Audit_Passed-green?logo=github-actions&logoColor=white) ![Ruff](https://img.shields.io/badge/Ruff-checked-green?logo=ruff&logoColor=white)
![Python](https://img.shields.io/badge/python-3.11-blue.svg)  ![Linter](https://img.shields.io/badge/linter-ruff-orange.svg)  ![License](https://img.shields.io/badge/license-MIT-green.svg) ![uv](https://img.shields.io/badge/managed%20by-uv-de5b41.svg) ![Docker](https://img.shields.io/badge/docker-ready-blue.svg?logo=docker) ![Last Commit](https://img.shields.io/github/last-commit/Lionel-JOURDHIER/Prefect_MINIO) ![Repo Size](https://img.shields.io/github/repo-size/Lionel-JOURDHIER/Prefect_MINIO) ![Open Issues](https://img.shields.io/github/issues/Lionel-JOURDHIER/Prefect_MINIO)
![Contributeurs](https://img.shields.io/github/contributors/Lionel-JOURDHIER/Prefect_MINIO?logo=github&color=orange)

### Liste des contributeurs
[![Contributeurs](https://contrib.rocks/image?repo=Lionel-JOURDHIER/Prefect_MINIO)](https://github.com/Lionel-JOURDHIER/Prefect_MINIO/graphs/contributors)
